# TODO: basic stuff should go here such as resources not found.


# def init_routes(app, users_dynamodb_client: UsersDynamoDBClient, chatBotService: ChatBotService):
